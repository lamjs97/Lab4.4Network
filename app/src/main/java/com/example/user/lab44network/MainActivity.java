...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            downloadCourse(getApplicationContext(), getString(R.string.get_course_url));  //when the sync icon is press
        }
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                caList.add(course);
                            } //never read data in volley call
                            loadCourse();
                            if (pDialog.isShowing())
                                pDialog.dismiss();
                        } catch (Exception e) {
    ...
    @Override //user away from he app
